...
window.onload = function init(){
    ...
    document.getElementById( "xReset" ).onclick = function () {theta[xAxis] = 0;};
    document.getElementById( "yReset" ).onclick = function () {theta[yAxis] = 0;};
    document.getElementById( "zReset" ).onclick = function () {theta[zAxis] = 0;};
